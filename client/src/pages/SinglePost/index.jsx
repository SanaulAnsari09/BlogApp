...
//       <div className="h-50 w-full flex flex-col md:flex-row gap-4 mb-6">
//         <div className="h-64 md:h-80 w-full md:w-80 bg-gray-200 rounded-lg"></div>
//         <div className="h-full w-full md:w-[calc(100%-320px)] p-4 bg-gray-50 rounded-lg">
...
//         </div>
//       </div>
//       <div className="h-auto w-full p-1 mt-5">
...
//     <div className="min-h-30 bg-gray-100 rounded-lg py-4 px-2 mt-6 animate-pulse">
...
//           <PostSkeleton />
//         ) : (
//           <div className="w-full max-w-[1200px]  p-5 border border-gray-200 rounded-md">
...
//               <div className="w-full md:w-3/5 bg-white p-6 rounded-xl">
//                 <h1 className="text-3xl font-bold text-gray-800 mb-4">
//                   {singlePost?.Title}
//                 </h1>
//                 <div
//                   className="text-gray-600 prose max-w-none line-clamp-5"
...
//         {/* Comments Section */}
//         <div className="w-full max-w-[1200px] mt-5 border border-gray-200 rounded-md p-5">
//           {isLoading ? (
//             <CommentSkeleton />
//           ) : (
...
//                   type="text"
//                   name="Comment"
//                   className="flex-1 h-12 border border-gray-300 rounded-lg bg-gray-50 px-4 outline-none focus:ring-2 focus:ring-blue-400"
...
//                 />
//                 <button
//                   className="h-12 px-6 bg-blue-500 rounded-lg text-white font-medium flex items-center justify-center hover:bg-blue-600 transition-colors disabled:opacity-50"
//                   onClick={addComment}
//                   disabled={isSubmittingComment}
//                 >
//                   {isSubmittingComment ? (
...
//                             {/* You could add a timestamp here if available */}
//                           </span>
//                         </div>
